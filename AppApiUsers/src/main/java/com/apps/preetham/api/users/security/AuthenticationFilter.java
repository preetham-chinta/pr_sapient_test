package com.apps.preetham.api.users.security;
...
import com.apps.preetham.api.users.service.UsersService;
import com.apps.preetham.api.users.shared.UserDto;
import com.apps.preetham.api.users.ui.model.LoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain,
		...
		SecretKey secretKey = new SecretKeySpec(secretKeyBytes, SignatureAlgorithm.HS512.getJcaName()); // create signin key
		...
		// add to header to return back to client application
